<div class="container">			
    <!-- section title -->
    <h2 class="section-title wow fadeIn">Map</h2>
...
<script>
    (function() {
        ...
        for(var i = 0; i < states.length; i++) {
            ...
            alert('Show Coronavirus data for : ' + this.getAttribute('name') + ' ' + this.getAttribute('code'));
            //code to switch data and display Numbers IN HERE -> guide to #about
        }
    }
